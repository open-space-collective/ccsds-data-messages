...
class KVNOMMWriter:
    ...
    def _write(
        ...
        *,
        ...
        """
        Serialize a validated OMM domain model to a KVN file.

        Args:
            message (OMM): Validated OMM instance to serialize.
        ...
        # Mean Keplerian elements (table 4-3, section 4.2.4): mandatory.
        ...
        # TLE related parameters (table 4-3, section 4.2.4.6): conditional.
        if message.data.tle_related_parameters is not None:
            emit_block(message.data.tle_related_parameters, out, options=options)
            out.write("\n")

        # Covariance matrix (table 4-3, section 4.2.4.5): flat KVs, no block
        ...
        # User-defined parameters (table 4-3, section 4.2.4.10): optional.
    ...
    def write(
        ...
        *,
        ...
        """
        Serialize a validated OMM domain model to a KVN file at ``path``.
    ...
    def write_string(
        ...
        *,
        ...
        """
        Serialize a validated OMM domain model to a KVN string.
