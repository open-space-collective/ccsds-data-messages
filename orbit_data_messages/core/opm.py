...
class OPM(BaseModel):
    ...
    class Header(BaseModel):
        ccsds_opm_vers: Annotated[
            ...
            Metadata(keyword="CCSDS_OPM_VERS"),
        ]
        ...
        classification: Annotated[
            ...
            Metadata(keyword="CLASSIFICATION"),
        ] = None
        ...
        creation_date: Annotated[
            ...
            Metadata(keyword="CREATION_DATE"),
        ]
    ...
    class Metadata(BaseModel):
        ...
        ref_frame_epoch: Annotated[
            ...
            Metadata(keyword="REF_FRAME_EPOCH"),
        ] = None
        ...
        def validate_ref_frame_not_teme(cls, v: RefFrame) -> RefFrame:
            if v == RefFrame.TEME:
                raise ValueError(
                    ...
                    "TEME is only permitted in OMMs."
                )
            return v
    ...
    class Data(BaseModel):
        ...
        class OsculatingKeplerianElements(BaseModel):
            ...
            def check_anomaly_exclusive(self) -> "OPM.Data.OsculatingKeplerianElements":
                has_true = self.true_anomaly is not None
                has_mean = self.mean_anomaly is not None
        ...
        class SpacecraftParameters(BaseModel):
            ...
            solar_rad_coeff: Annotated[
                ...
                Metadata(keyword="SOLAR_RAD_COEFF"),
            ] = None
        ...
        class CovarianceMatrix(BaseModel):
            ...
            cov_ref_frame: Annotated[
                ...
                Metadata(keyword="COV_REF_FRAME"),
            ] = None
            ...
            @model_validator(mode="after")
            def check_covariance_positive_definite_proxy(self) -> "OPM.Data.CovarianceMatrix":
                """
        ...
        class ManeuverParameters(BaseModel):
            ...
            man_epoch_ignition: Annotated[
                ...
                Metadata(keyword="MAN_EPOCH_IGNITION"),
            ] = None
            ...
            man_ref_frame: Annotated[
                ...
                Metadata(keyword="MAN_REF_FRAME"),
            ] = None
        ...
        class UserDefinedParameters(BaseModel):
            ...
            """
            user_defined: dict[str, Any | None] = Field(
        ...
        user_defined: list[UserDefinedParameters] | None = Field(
            default=None,
            description=(
